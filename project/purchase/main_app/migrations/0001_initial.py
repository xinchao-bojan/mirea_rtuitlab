    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default', models.BooleanField(default=False, verbose_name='Стандартная категория')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.purchase', verbose_name='Покупка')),
            ],
        ),
    ]
